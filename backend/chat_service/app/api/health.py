"""
Chat Service Health Check Endpoints - Using Shared Health System
"""
...
# Create dependency checks for chat service
def create_chat_health_router() -> APIRouter:
    """Create health router with chat service specific dependencies"""
    ...
    dependency_checks = [
        ...
        DependencyCheck("llm_api", lambda: check_openai_api(settings)),
    ]
...
# Create the router
router = create_chat_health_router()
